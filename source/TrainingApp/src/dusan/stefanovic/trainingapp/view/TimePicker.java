...
import dusan.stefanovic.numberpicker.NumberPicker;
import dusan.stefanovic.numberpicker.NumberPicker.Formatter;
...
public class TimePicker extends FrameLayout {
    ...
    public static final Formatter TWO_DIGIT_FORMATTER = new Formatter() {
			...
			return String.format(locale, "%02d", value);
		}
	};
    ...
    public TimePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        inflater.inflate(R.layout.view_time_picker,
