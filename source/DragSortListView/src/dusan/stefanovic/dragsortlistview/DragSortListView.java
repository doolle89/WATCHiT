...
package dusan.stefanovic.dragsortlistview;
...
import dusan.stefanovic.dragsortlistview.R;
...
public class DragSortListView extends ListView {
    ...
    protected void adjustItem(int position) {
        View v = getChildAt(position - getFirstVisiblePosition());
    ...
    protected boolean mFloatViewInvalidated = false;

    protected void invalidateFloatView() {
    ...
    protected class DragScroller implements Runnable {
        ...
        protected int mLastHeader;
        protected int mFirstFooter;
